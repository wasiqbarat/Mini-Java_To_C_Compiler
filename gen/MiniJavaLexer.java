...
public class MiniJavaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"DIGIT", "LETTER", "IntegerLiteral", "Identifier", "CLASS", "PUBLIC", 
			"STATIC", "VOID", "MAIN", "STRING", "EXTENDS", "INT", "BOOLEAN", "IF", 
			"ELSE", "WHILE", "DO", "FOR", "RETURN", "BREAK", "CONTINUE", "THIS", 
			"NEW", "TRUE", "FALSE", "LEN", "PRINTLN", "AND", "LT", "ASSIGN", "PLUS", 
			"MINUS", "MULT", "DIV", "NOT", "DOT", "COMMA", "SEMICOLON", "LPAREN", 
			"RPAREN", "LBRACE", "RBRACE", "LBRACK", "RBRACK", "WS", "LINE_COMMENT", 
			"BLOCK_COMMENT"
		};
	}
